...
namespace mwx { inline namespace L1 {
	uint8_t CRC8_u8Calc(const uint8_t *pu8Data, uint8_t size, uint8_t initval = 0);
	uint8_t CRC8_u8CalcU32(uint32_t u32c, uint8_t initval = 0);
	uint8_t CRC8_u8CalcU16(uint16_t u16c, uint8_t initval = 0);
	uint8_t XOR_u8Calc(const uint8_t *pu8Data, uint8_t size);
	uint8_t LRC_u8Calc(const uint8_t* pu8Data, uint8_t size);
}}
